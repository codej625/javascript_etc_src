...
```
box 클래스 안에 childNodes[] 와 children[] 으로 노드를 선택 할 수 있는데,
childNodes[]는 코드 내 빈공백도 자식으로 인식하기 때문에 children[]을 사용해서 box클래스 태그안에 있는 input을 선택해준다.
```